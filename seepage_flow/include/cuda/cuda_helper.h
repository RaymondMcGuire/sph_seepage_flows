...
inline std::vector<size_t> TransferGPUData2CPU(const size_t *gpu_data,
                                               const uint size) {
...
inline std::vector<int> TransferGPUData2CPU(const int *gpu_data,
                                            const uint size) {
...
inline std::vector<uint> TransferGPUData2CPU(const uint *gpu_data,
                                             const uint size) {
...
inline std::vector<int2> TransferGPUData2CPU(const int2 *gpu_data,
                                             const uint size) {
...
inline std::vector<int3> TransferGPUData2CPU(const int3 *gpu_data,
                                             const uint size) {
...
inline std::vector<int4> TransferGPUData2CPU(const int4 *gpu_data,
                                             const uint size) {
...
inline std::vector<float> TransferGPUData2CPU(const float *gpu_data,
                                              const uint size) {
...
inline std::vector<float2> TransferGPUData2CPU(const float2 *gpu_data,
                                               const uint size) {
...
inline std::vector<float3> TransferGPUData2CPU(const float3 *gpu_data,
                                               const uint size) {
...
inline std::vector<float4> TransferGPUData2CPU(const float4 *gpu_data,
                                               const uint size) {

 ...
 * @LastEditors: Xu.WANG
 * @Description: 
 * @FilePath: \Kiri\KiriPBSCuda\include\kiri_pbs_cuda\solver\seepageflow\cuda_sph_sf_solver.cuh
 */
...
namespace KIRI
{
    ...
    protected:
        ...
        virtual void ComputeAvgFlowVelocity(
            CudaSFParticlesPtr &particles,
            const CudaArray<size_t> &cellStart,
            const float3 lowestPoint,
            const float kernelRadius,
        ...
        virtual void ComputeSFSandVoidage(
            CudaSFParticlesPtr &particles,
            const CudaArray<size_t> &cellStart,
            const float3 lowestPoint,
            const float kernelRadius,
        ...
        virtual void ComputeMultiSFWaterAdhesion(
            CudaSFParticlesPtr &particles,
            const CudaArray<size_t> &cellStart,
            const float3 lowestPoint,
            const float kernelRadius,
        ...
        virtual void ComputeSFWetSandColor(
            CudaSFParticlesPtr &particles,

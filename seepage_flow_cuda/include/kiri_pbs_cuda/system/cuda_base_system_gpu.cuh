 ...
 * @Description:
 * @FilePath:
 * \Kiri\KiriPBSCuda\include\kiri_pbs_cuda\system\cuda_base_system_gpu.cuh
 */
...
static __global__ void TransferGPUData2VBO_CUDA(float4 *pos, float4 *col,
                                                float3 *lpos, float3 *lcol,
                                                const float radius,
                                                const size_t num,
                                                const size_t type) {

...
inline __host__ __device__ tensor3x3 make_tensor3x3(float3 e1, float3 e2,
                                                    float3 e3) {
  tensor3x3 t3x3;
  t3x3.e1 = e1;
  t3x3.e2 = e2;
...
inline __host__ __device__ tensor3x3 dot(tensor3x3 a, tensor3x3 b) {
  ...
  tensor3x3 result;
  result.e1 = make_float3(a11 * b11 + a12 * b21 + a13 * b31,
                          a11 * b12 + a12 * b22 + a13 * b32,
                          a11 * b13 + a12 * b23 + a13 * b33);
  result.e2 = make_float3(a21 * b11 + a22 * b21 + a23 * b31,
                          a21 * b12 + a22 * b22 + a23 * b32,
                          a21 * b13 + a22 * b23 + a23 * b33);
  result.e3 = make_float3(a31 * b11 + a32 * b21 + a33 * b31,
...
inline __host__ __device__ float ddot(tensor3x3 a, tensor3x3 b) {
  ...
  float result = a11 * b11 + a12 * b12 + a13 * b13 + a21 * b21 + a22 * b22 +
...
inline __host__ __device__ float det(tensor3x3 a) {
  ...
  float result = a11 * a22 * a33 + a12 * a23 * a31 + a13 * a21 * a32 -
...
inline __host__ __device__ tensor3x3 adj(tensor3x3 a) {
  ...
  tensor3x3 result;
  result.e1 = make_float3(a22 * a33 - a32 * a23, (a21 * a33 - a31 * a23) * -1.f,
                          a21 * a32 - a22 * a31);
  result.e2 = make_float3((a12 * a33 - a13 * a32) * -1.f, a11 * a33 - a13 * a31,
                          (a11 * a32 - a12 * a31) * -1.f);
  result.e3 = make_float3(a12 * a23 - a22 * a13, (a11 * a23 - a21 * a13) * -1.f,
                          a11 * a22 - a21 * a12);
...
inline __host__ __device__ float second_stress_invariants(tensor3x3 t3x3) {
  float e11 = t3x3.e1.x, e12 = t3x3.e1.y, e13 = t3x3.e1.z, e22 = t3x3.e2.y,
        e23 = t3x3.e2.z, e33 = t3x3.e3.z;
  float I2 =
      e11 * e22 + e22 * e33 + e11 * e33 - e12 * e12 - e23 * e23 - e13 * e13;
  return I2;
}

inline __host__ __device__ float third_stress_invariants(tensor3x3 t3x3) {
  float e11 = t3x3.e1.x, e12 = t3x3.e1.y, e13 = t3x3.e1.z, e22 = t3x3.e2.y,
        e23 = t3x3.e2.z, e31 = t3x3.e3.x, e33 = t3x3.e3.z;
  float I3 = e11 * e22 * e33 + 2 * e12 * e23 * e31 - e12 * e12 * e33 -
             e23 * e23 * e11 - e13 * e13 * e22;
  return I3;
}

inline __host__ __device__ float
first_deviatoric_stress_invariants(tensor3x3 t3x3) {
  float J1 = 0.f;
  return J1;
}

inline __host__ __device__ float
second_deviatoric_stress_invariants(tensor3x3 t3x3) {
...
inline __host__ __device__ float
second_deviatoric_stress_invariants_by_deviatoric_tensor(tensor3x3 t3x3) {
  float e11 = t3x3.e1.x, e12 = t3x3.e1.y, e13 = t3x3.e1.z, e22 = t3x3.e2.y,
        e23 = t3x3.e2.z, e33 = t3x3.e3.z;
  float J2 = 0.5f * (e11 * e11 + e22 * e22 + e33 * e33 + 2 * e12 * e12 +
                     2 * e23 * e23 + 2 * e13 * e13);
  return J2;
}

inline __host__ __device__ float
third_deviatoric_stress_invariants(tensor3x3 t3x3) {
  float I1 = first_stress_invariants(t3x3);
  float I2 = second_stress_invariants(t3x3);

 ...
 * @Description:
 * @FilePath:
 * \Kiri\KiriPBSCuda\include\kiri_pbs_cuda\particle\cuda_boundary_particles.cuh
 */
...
public:
  explicit CudaBoundaryParticles::CudaBoundaryParticles(const Vec_Float3 &p)
      : CudaParticles(p), mVolume(p.size()), mLabel(p.size()) {}
